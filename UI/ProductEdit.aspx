<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" Inherits="HaatBazeer.UI.ProductEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <h3 class=" text-center text-danger">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyCon %>"
                  ...
                  UpdateCommand="UPDATE [Product] SET [name] = @name, [tag] = @tag, [price] = @price, [description] = @description, [userId] = @userId, [categoryId] = @categoryId, [updateHistory] = @updateHistory, [statuId] = @statuId WHERE [id] = @original_id">
                     <DeleteParameters>
    ...
    <br/>
    <br/>
    <a href="Product.aspx">Back To Product Page</a>
            </div>
             <div class="col-md-2"></div>
        </div>
    </div>
